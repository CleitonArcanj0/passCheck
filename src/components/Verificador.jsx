        ...
        <div className=" flex bg-white  shadow-sm rounded-lg  p-8 md:p-4  h-full">
            ...
            <div className='space-y-2 basis-xl m-auto '>
                ...
                <div className=' relative'>
                    <img src={eyes} alt="" className='w-5 absolute right-3 top-1/2 -translate-y-1/2 cursor-pointer' />

                    <input type="text" placeholder='Digite sua senha' className="border border-gray-400 outline-0 p-1.5 text-xs text-gray-500 rounded-sm focus:ring-[#6249F0]  focus:ring-1 w-full placeholder:text-xs" onChange={(e) => { aoDigitarSenha(e.target.value) }} />
